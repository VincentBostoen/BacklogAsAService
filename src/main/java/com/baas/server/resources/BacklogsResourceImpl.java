...
@Singleton
@Path(ResourcePaths.BACKLOGS_PATH)
@Produces(MediaType.APPLICATION_JSON)
public class BacklogsResourceImpl extends GenericResource<Long, Backlog, BacklogDao>{

	@Inject
	public BacklogsResourceImpl(BacklogDao dao) {
		super(dao);
	}
